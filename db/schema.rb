...
ActiveRecord::Schema.define(version: 2020_10_21_072910) do
  ...
  create_table "pictures", force: :cascade do |t|
    ...
    t.integer "imageable_id_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["imageable_id_id"], name: "index_pictures_on_imageable_id_id"
  end
  ...
  add_foreign_key "pictures", "imageable_ids"
end
